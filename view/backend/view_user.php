		...
		<div class="card border-primary">
			<div class="card card-header bg-primary text-white" style="padding:7px !important;">Login</div>
				...
				<?php 
				 ...
				 ?>
					<tr>
						<td><?php echo $rows->us_name; ?></td>
						<td><?php echo $rows->us_password; ?></td>
						<td style="text-align: center;">
							<a href="admin.php?controller=add_edit_user&act=edit&id=<?php echo $rows->us_id; ?>">Edit</a>&nbsp;&nbsp;
							<a href="admin.php?controller=user&act=delete&id=<?php echo $rows->us_id; ?>" onclick="window.confirm('Are you sure?');">delete</a>
						</td>
					</tr>
				<?php } ?>
				</table>
